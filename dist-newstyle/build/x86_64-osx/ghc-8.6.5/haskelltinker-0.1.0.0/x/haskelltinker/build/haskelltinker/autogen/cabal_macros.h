...
/* package haskelltinker-0.1.0.0 */
#ifndef VERSION_haskelltinker
#define VERSION_haskelltinker "0.1.0.0"
#endif /* VERSION_haskelltinker */
#ifndef MIN_VERSION_haskelltinker
#define MIN_VERSION_haskelltinker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskelltinker */
...
#define CURRENT_COMPONENT_ID "haskelltinker-0.1.0.0-inplace-haskelltinker"
